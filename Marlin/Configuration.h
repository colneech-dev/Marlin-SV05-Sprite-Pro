...
#define CONFIG_EXAMPLES_DIR "Sovol/SV05"
...
#define STRING_CONFIG_H_AUTHOR "(Colin, SV05 Sprite Pro + CR Touch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sovol SV05"
 ...
 */
#define TEMP_SENSOR_0 5   // Creality Sprite Pro 300°C (ATC Semitec 104GT-2, thick red wiring)
...
#define HEATER_0_MAXTEMP 300  // Sprite Pro 300°C rated; thermistor_5 table supports this
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  17.62  // Tuned for Creality Sprite Pro (M303 E0 S210 C15)
...
#define EXTRUDE_MAXLENGTH 500  // Direct drive needs longer for load/unload
 ...
 */
// SV05 Sprite Pro: Z=400 (SV05 lead screw), E=439.45 (Sprite Pro extruder)
#define DEFAULT_AXIS_STEPS_PER_UNIT { 80, 80, 400, 439.45 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 60 }  // E raised from 25 to 60 for Sprite Pro direct drive
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -37.5, 6.2, -4.825 } // CR Touch on Sprite Pro slim mount — XY measured by centering probe, Z calibrated with live baby-step tuning
 ...
 */
#define MULTIPLE_PROBING 2  // Probe each point twice and average — improves accuracy and catches false triggers
...
#endif
#define PROBING_FANS_OFF            // Turn fans off when probing — reduces vibration affecting CR Touch
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
#define DELAY_BEFORE_PROBING 200    // (ms) Wait for vibrations to settle before each probe point
